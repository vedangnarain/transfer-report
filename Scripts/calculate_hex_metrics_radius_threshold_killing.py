...
pruning thresholds. The metrics are: basic distribution stats, the perfusion 
...
#    folder_path = '/home/narain/Desktop/Stochastic Pruning with 100 Trials/' + solver_name + 'Haematocrit/Lambda4/Alpha' + alpha_value + '/Beta' + beta + '/Trial' + trial
    folder_path = '/scratch/narain/Hexagonal/Log Normal Distribution/Radius Threshold Pruning in Hexagonal Network with 100 Selections/TestHexagonalNetwork/' + solver_name + 'Haematocrit/Sigma' + sigma + '/Selection' + layout_selection + '/RadiusThreshold' + threshold
...
#        print(layout_selection)
        hypoxic_fraction_list, mean_value, min_value, half_value, max_value, std_value = get_distribution_stats(solver_name, str(layout_selection), sigma, str(threshold), hypoxic_threshold_list, plot, read)
...
# Save array
#np.save('/scratch/narain/Hexagonal/Log Normal Distribution/Radius Threshold Pruning in Hexagonal Network with 100 Selections/TestHexagonalNetwork/' + solver_name + 'Haematocrit/python_solver_data.npy', solver_stats)
...
# Read PQ file
filename = '/scratch/narain/Hexagonal/Log Normal Distribution/Radius Threshold Pruning in Hexagonal Network with 100 Selections/TestHexagonalNetwork/hex_lognormal_radius_threshold_perfusion_quotients.txt'
...
line_1 = get_alpha_line(alpha_1, max_threshold)
line_2 = get_alpha_line(alpha_2, max_threshold)
line_3 = get_alpha_line(alpha_3, max_threshold)
line_4 = get_alpha_line(alpha_4, max_threshold)
