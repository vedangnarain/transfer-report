...
mean = 12.5
lower_bound, upper_bound = 2.5, 37.5
n_vessels = 386
...
for sigma_number in alpha_list:
    for list_number in range(1,101):
        id_name = '/Users/vedang/Desktop/hexagonal_radius_log_normal_distribution/sigma_' + str(sigma_number) + '/id_list_' + str(list_number) + '.txt'
        radii_name = '/Users/vedang/Desktop/hexagonal_radius_log_normal_distribution/sigma_' + str(sigma_number) + '/radii_list_' + str(list_number) + '.txt'
...
# Save image
file_path = Path('~/Desktop/Final Figures/hexagonal_radius_log_normal_distribution.svg').expanduser()
fig.savefig(file_path, dpi=500)
file_path = Path('~/Desktop/Final Figures/hexagonal_radius_log_normal_distribution.png').expanduser()
fig.savefig(file_path, dpi=500)
