...
Calculate metrics of Forking Network with stochastic pruning. The metrics are: 
...
def get_distribution_stats(solver_name, trial, alpha_value, beta, hypoxic_threshold_list, plot=0, read=0):    
    ...
    # Set the file path
    folder_path = '/home/narain/Desktop/Link to narain/Forking/Nonrandom/Stochastic Pruning in Nonrandom Forking Network with 100 Trials/TestDichotomousNetwork/' + solver_name + 'Haematocrit/Lambda4/Alpha' + alpha_value + '/Beta' + beta + '/Trial' + trial
...
# Save array
np.save('/home/narain/Desktop/Link to narain/Forking/Nonrandom/Stochastic Pruning in Nonrandom Forking Network with 100 Trials/TestDichotomousNetwork/' + solver_name + 'Haematocrit/python_solver_data.npy', solver_stats)
solver_stats = np.load('/home/narain/Desktop/Link to narain/Forking/Nonrandom/Stochastic Pruning in Nonrandom Forking Network with 100 Trials/TestDichotomousNetwork/' + solver_name + 'Haematocrit/python_solver_data.npy')
...
# Read PQ file
filename = '/home/narain/Desktop/Link to narain/Forking/Nonrandom/Stochastic Pruning in Nonrandom Forking Network with 100 Trials/TestDichotomousNetwork/forking_stochastic_pruning_perfusion_quotients.txt'
